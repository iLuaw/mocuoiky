      ...
      if ($show_products->rowCount() > 0) {
         ...
         while ($fetch_products = $show_products->fetch(PDO::FETCH_ASSOC)) {
            ...
            <form action="" method="POST" enctype="multipart/form-data">
               ...
               <span>Giá tiền</span>
               <input type="number" min="0" max="9999999999" required placeholder="Nhập giá tiền" name="price"
               ...
               <select name="category" hidden class="box" required>
                  <!-- Các option cho loại sản phẩm -->

                  <option selected value="Hoa">Hoa</option>
               </select>
